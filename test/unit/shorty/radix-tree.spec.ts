...
describe('RadixTree', () => {
    ...
    it('can add/remove one piece of stored data', () => {
    ...
    it('can add/remove two strings w/ different first letters', () => {
        const tree = new RadixTree();
    ...
    it('can add/remove two strings w/ same first letter', () => {
        const tree = new RadixTree();
        tree.add('map', 'value 1');
    ...
    it('can add/remove longer string when whole substring exists', () => {
        const tree = new RadixTree();
        tree.add('map', 'value 1');
    ...
    it('can add/remove substring when longer string exists', () => {
        const tree = new RadixTree();
        tree.add('maps', 'value 1');
